...
//
// Evaluation contract and problem evaluation (plan 1.2: evaluation separated from solver).
// ---------------------------------------------------------------------------
...
pub(crate) fn assigned_students_are_adjacent(
...
pub(crate) fn assigned_students_meet_distance(
