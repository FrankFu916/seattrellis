...
**席序（SeatTrellis）v2.0.0** 通过本地服务（`seattrellis_web` / `seattrellis-server`）暴露了高性能、类型安全的 HTTP API。完整 OpenAPI 规范可在 [GitHub 查看](https://github.com/FrankFu916/seattrellis/blob/main/docs/api-v1-openapi.json)。
